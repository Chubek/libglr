 ...
 */
static inline glr_graph_edge_t **glr_graph_node_outgoing(glr_graph_node_t *node) {
 ...
 */
static inline glr_graph_edge_t **glr_graph_node_incoming(glr_graph_node_t *node) {
 ...
 */
static inline size_t glr_graph_node_outgoing_count(glr_graph_node_t *node) {
 ...
 */
static inline size_t glr_graph_node_incoming_count(glr_graph_node_t *node) {
