...
extern "C"
{
   ...
   *
   * Provides access to parser state, forest structure, and reduction
   * candidates. This is the primary interface for disambiguation strategies.
   */
...
#define GLR_PRIORITY_MAXIMUM (1000000)
  ...
  typedef glr_priority_t (*glr_strategy_priority_callback_t) (
      void *user_data, const glr_disambiguation_context_t *context,
   ...
   * @return 0 on success, -1 on error
   */
  typedef int (*glr_strategy_hook_callback_t) (void *user_data,
  ...
  typedef struct glr_disambiguation_strategy
  {
    ...
    glr_strategy_priority_callback_t
        priority_fn; ///< Optional priority computation
    ...
    glr_strategy_hook_callback_t
        post_hook_fn;              ///< Optional post-resolution hook
   ...
   */
  glr_disambiguation_result_t *
  glr_disambiguation_result_alloc (size_t capacity);
   ...
   */
  glr_disambiguation_result_t *
  glr_disambiguation_result_single (glr_reduction_t *winner);
   ...
   */
  glr_disambiguation_result_t *
  glr_disambiguation_result_multi (glr_reduction_t **reductions, size_t count);
   ...
   */
  glr_disambiguation_result_t *
  glr_disambiguation_result_copy (const glr_disambiguation_result_t *source);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_create (const char *name);
   ...
   */
  void glr_disambiguation_strategy_destroy (
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_chain (glr_disambiguation_strategy_t *a,
  ...
  void glr_disambiguation_config_set_default_priority (
      glr_disambiguation_config_t *config, glr_priority_t priority);
  ...
  void glr_disambiguation_config_allow_ambiguity (
      glr_disambiguation_config_t *config, bool allow);
  ...
  void glr_disambiguation_config_set_strict_mode (
      glr_disambiguation_config_t *config, bool strict);
   ...
   */
  glr_disambiguator_t *
  glr_disambiguator_create (glr_disambiguation_config_t *config);
   ...
   */
  glr_disambiguation_result_t *
  glr_disambiguator_disambiguate (glr_disambiguator_t *disambiguator,
   ...
   */
  glr_disambiguation_config_t *
  glr_disambiguator_get_config (glr_disambiguator_t *disambiguator);
   ...
   */
  void glr_disambiguator_set_user_data (glr_disambiguator_t *disambiguator,
                                        void *user_data);
   ...
   */
  void *glr_disambiguator_get_user_data (glr_disambiguator_t *disambiguator);
   ...
   *
   * @param default_priority Default priority for productions with no explicit
   * priority
   * @return Strategy, or NULL on error
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_priority (glr_priority_t default_priority);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_precedence (glr_priority_t default_precedence);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_right_assoc (void);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_longest_match (void);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_production_freq (void);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_semantic_predicate (
   ...
   */
  const char *
  glr_disambiguation_decision_string (glr_disambiguation_decision_t decision);
   ...
   */
  void
  glr_disambiguation_log_context (const glr_disambiguation_context_t *context);
   ...
   */
  void
  glr_disambiguation_log_result (const glr_disambiguation_result_t *result);
   ...
   */
  glr_disambiguation_strategy_t *
  glr_disambiguation_strategy_from_lua (void *lua_fn);
