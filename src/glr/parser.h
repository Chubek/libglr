 ...
 */
static inline void glr_parser_set_user_data(glr_parser_t *parser, void *data) {
    if (parser != NULL) {
 ...
 */
static inline void *glr_parser_get_user_data(glr_parser_t *parser) {
 ...
 * @return Error code
 */
static inline glr_parse_error_t glr_parser_get_error(glr_parser_t *parser) {
 ...
 */
static inline glr_forest_t *glr_parser_get_forest(glr_parser_t *parser) {
 ...
 */
static inline size_t glr_parser_stack_count(glr_parser_t *parser) {
